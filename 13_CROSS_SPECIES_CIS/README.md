...
## Status (2026-09-23, post-arbitration)

- P0 provenance: DONE (see `..\00_Metadata\AOMIC_VERIFICATION_REPORT.md`,
  `CHECKSUMS_AOMIC.sha256`, `aomic_zenodo_record.json`)
- P0 novelty gate: **GO, precisely bounded** — see `RESEARCH_LOG.md` E00
- P1 protocol freeze: PENDING (must happen before any computation)
